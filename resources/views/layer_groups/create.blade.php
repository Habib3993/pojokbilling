                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center gap-3">
                                    <div id="color-preview" class="w-12 h-8 rounded border-2 border-gray-300" style="background-color: {{ old('color', '#3b82f6') }}"></div>
                                    <div class="relative">
                                ...
                                <input type="hidden" name="color" id="color-input" value="{{ old('color', '#3b82f6') }}">
